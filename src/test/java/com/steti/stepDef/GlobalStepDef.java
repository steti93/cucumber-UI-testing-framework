...
public class GlobalStepDef {
    ...
    public void userClicksOnSimpleFileDownloadFromCurrentPage(String webElement) {
        ...
        foundElement.click();
        makeScreenshot(scenarioContext.getData(PageScenarioKeys.SCENARIO_NAME), scenarioContext.getData(PageScenarioKeys.OPEN_DRIVER));
        scenarioContext.save(PageScenarioKeys.LAST_CLICKED, foundElement);
    }
    ...
    public void pageIsDisplayed(PageNames pageNames) throws Exception {
        WebDriver driver = scenarioContext.getData(PageScenarioKeys.OPEN_DRIVER);
    ...
    public void dialogWithFollowingMessageIsDisplayed(String elementName, DataTable dataTable) {
        ...
        AbstractPage currentPage = scenarioContext.getData(PageScenarioKeys.CURRENT_PAGE);
    ...
    public void userInsertsFollowingDataInCurrentPage(List<ItemList> dataTableValues) {
        WebDriver webDriver = scenarioContext.getData(PageScenarioKeys.OPEN_DRIVER);
        AbstractPage currentPage = scenarioContext.getData(PageScenarioKeys.CURRENT_PAGE);
        for (ItemList itemList : dataTableValues) {
            ...
            if (itemList.getFieldValue().contains("%s")) {
                ...
                scenarioContext.save(PageScenarioKeys.TEST_EMAIL, userTestEmail);
                webElement.sendKeys(userTestEmail);
                highLighterMethod(webDriver, webElement);
                makeScreenshot(scenarioContext.getData(PageScenarioKeys.SCENARIO_NAME), webDriver);
            } else {
    ...
    public void userInsertsAnExistingEmail() {
        String usedEmail = scenarioContext.getData(PageScenarioKeys.TEST_EMAIL);
        AbstractPage currentPage = scenarioContext.getData(PageScenarioKeys.CURRENT_PAGE);
    ...
    public void userClicksOnElementPath(String elementPath) {
        ...
        element.click();
        makeScreenshot(scenarioContext.getData(PageScenarioKeys.SCENARIO_NAME), driver);
    }
    ...
    public void pageContainsFollowingEmailForSpecifiedElements(String webElement) {
        AbstractPageObject currentPage = scenarioContext.getData(PageScenarioKeys.CURRENT_PAGE);
        WebElement foundElement = getWebElementByObjectAndName(currentPage, webElement);
        assertTrue("Content of found element don't match", PageScenarioKeys.TEST_EMAIL.toString().contains(foundElement.getText()));
    }
    ...
    public void userSelectRandomValueForSelectWithNameDegreePath(String elementName) {
        ...
        scenarioContext.save(PageScenarioKeys.LIST_RANDOM_VALUES, valuesToSave);
    }
    ...
    public void webElementTxtLoginDisplayFollowingMessage(String elementName, DataTable dataTable) {
        ...
        AbstractPage page = scenarioContext.getData(PageScenarioKeys.CURRENT_PAGE);
